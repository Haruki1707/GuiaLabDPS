...
export default function AddBirthday(props) {
        ...
        if (!formData.name || !formData.lastname || !formData.dateBirth) {
            ...
            addBirthday(data)
                ...
                .catch((e) => {
                    console.log(e);
                    setFormError({
                        name: true, lastname: true, dateBirth: true
                    });
                });
        }
        setFormError(errors);
    ...
    return (<>
            <View style={styles.container}>
                <TextInput
                    style={[styles.input, formError.name && {
                        borderColor: "#940c0c"
                    }]}
                    placeholder="Nombre"
                ...
                >
                    <Text
                        style={{
                            color: formData.dateBirth ? "#fff" : "#969696", fontSize: 18,
                        }}
...
const styles = StyleSheet.create({
    container: {
        ...
        fontSize: 18, color: "#fff", backgroundColor: "#1e3040",
    },
});
